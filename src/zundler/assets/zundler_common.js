...
const isVirtual = (url)=>{
  ...
  return !(_url === "" || _url[0] === "#" || _url.startsWith("https:/") || _url.startsWith("http:/") || _url.startsWith("data:") || _url.startsWith("javascript:") || _url.startsWith("about:srcdoc") || _url.startsWith("blob:"));
};
const splitUrl = (url)=>{
...
const fixLink = (a)=>{
  ...
  } else if (!href.startsWith("about:srcdoc") && !href.startsWith("javascript:")) {
